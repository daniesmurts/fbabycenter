...
if(isset($_GET['view'])){  
$categ_id =  $_GET['view'];     
$q = "SELECT * FROM categories WHERE id = $categ_id";
 $r = mysqli_query($dbc,$q);
while ($data = mysqli_fetch_array($r)){ 
$title = $data['title'];  
?>

			<h2 class="home_title"><?php echo $title; ?></h2>
<?php } } ?>			
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3">
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<?php include('res/shop_sidebar.php') ?>
						</div>
						...
						<div class="sidebar_section">
							...
							<?php include('res/brandlists_sidebar.php') ?>
						</div>
					</div>
				...
				<div class="col-lg-9">
					...
					<!-- Shop Content -->
					<?php include('res/shop_content.php') ?>
				</div>
			</div>
		</div>
	</div>
