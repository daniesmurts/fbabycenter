...
if(isset($_POST['save']))
				...
				$q = "INSERT INTO super_deals ( categ_id, title, price, descpt, color, size, quantity, available, discount, new, cover, cover2, cover3) VALUES( '$categ_id', '$title', '$price', '$descpt', '$color', '$size', '$quantity', '$available', '$discount', '$new', '$cover', '$cover2', '$cover3')";
										...
										if($r){
											...
											header("refresh:3 ; add_super_deal.php");
										}
										else
										{
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<h2 class="cat-heading">Add Super Deal </h2>
					</div>
					<div class="col-md-6 col-sm-12">
						<p> <a href="" class="setting_add">Add</a> &nbsp;/ &nbsp;<a href="super_deals.php"
