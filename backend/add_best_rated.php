...
session_start(); 
							 ...
							 require_once 'assets/includes/connexion.php';
								...
								{    
								   ...
								   if(empty($title)){
										...
										$errMSG = "Please, enter the Category Id.";
									} 
	...
	$q = "INSERT INTO best_rated (categ_id, title, color, new_price, cover, cover2, cover3) VALUES('$categ_id','$title', '$color', '$new_price', '$cover', '$cover2', '$cover3')";
										...
										if($r){
											...
											header("refresh:3 ; add_best_rated.php");
										}
										else
										{
			...
			<div class="col-lg-10 col-md-10 col-sm-12">
				...
				<div class="row container-title"><br />
					...
					<div class="col-lg-7 col-md-7 col-sm-12">
						<h2 class="cat-heading">Best rated</h2>
					</div>

					<div class="col-lg-5 col-md-5 col-sm-12 setting_links">
						<p> <a href="" class="setting_add">Add</a> &nbsp;/ &nbsp;<a href="all_on_sales.php"
								class="setting_edit">All rated</a> </p>
					</div>
