<div class="sidebar">
    ...
    <ul>
        <li><a href="/backend/categories/index.php">All Categories</a></li>
        <li><a href="/backend/brands/index.php">All Brands</a></li>
    </ul>
...
<nav id="sidebar">
    ...
    <ul class="list-unstyled CTAs">
        ...
        <li>
        <a  class="download" href="/backend/login/logout.php">Logout</a>
        </li>
    </ul>
</nav>