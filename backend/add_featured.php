...
session_start(); 
	...
	$q = "INSERT INTO featured (categ_id, title, color, new_price, cover, cover2, cover3) VALUES('categ_id','$title', '$color', '$new_price', '$cover', '$cover2','$cover3')";
										...
										if($r){
											...
											header("refresh:3 ; add_featured.php");
										}
										else
										{
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12">
						<p> <a href="" class="setting_add">Add</a> &nbsp;/ &nbsp;<a href="all_featured.php"
								class="setting_edit">All featured</a> </p>
					</div>
				</div>
				<div class="row">
