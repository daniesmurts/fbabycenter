...
session_start(); 
	...
	$q = "INSERT INTO on_sales (categ_id, title, color, new_price, cover, cover2, cover3) VALUES('$categ_id','$title', '$color', '$new_price', '$cover', '$cover2', '$cover3')";
										...
										if($r){
											...
											header("refresh:3 ; add_on_sales.php");
										}
										else
										{
