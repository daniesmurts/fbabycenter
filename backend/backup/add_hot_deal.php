...
session_start(); 
							 ...
							 require_once 'assets/includes/connexion.php';
								...
								{    
								   ...
								   if(empty($title)){
										...
										$errMSG = "Please, select a discount percentage.";
									}  
	...
	$q = "INSERT INTO hot_deals (categ_id, title, new_price, old_price, discount, cover, cover2, cover3) VALUES('$categ_id','$title', '$new_price', '$old_price','$discount', '$cover', '$cover2', '$cover3')";
										...
										if($r){
											...
											header("refresh:3 ; add_hot_deal.php");
										}
										else
										{
            ...
            <div class="col-lg-10 col-md-10 col-sm-12">
                ...
                <div class="row container-title"><br />
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <h2 class="cat-heading">Hot Deals</h2>
                    </div>

                    <div class="col-lg-5 col-md-5 col-sm-12 setting_links">
                        <p> <a href="" class="setting_add">Add</a> &nbsp;/ &nbsp;<a href="all_hot_deals.php"
                                class="setting_edit">All Hot Deals</a> </p>
                    </div>
    ...
    ?>
                  ...
                  <select class="form-control" name="categ_id" id="">
                    ...
                    <?php } ?>
                                ...
                                <div class="form-group">
                                    <label for="title"> Product Discount Percentage : </label>
