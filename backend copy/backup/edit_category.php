             ...
             header("location:index.php");
							 ...
							 require_once 'assets/includes/connexion.php';
								...
								{     
								   ...
								   if(empty($title)){
										$errMSG = "Enter Category title.";
									}  
									else if(empty($descpt)){
										$errMSG = "Enter category Description.";
									}
...
$q ="UPDATE categories SET title='$title', descpt='$descpt' WHERE id=$id";
$r = mysqli_query($dbc,$q);
										...
										if($r){
											...
											header("refresh:3 ; all_categories.php");
										}
										else
										{
											$errMSG = "Sorry, an error occured. Data was not updated...";
										}
...
<body>
  ...
  <div class="container-fluid main-container">
      ...
      <div class="col-lg-10 col-md-10 col-sm-12">
        ...
        <div class="row container-title"><br />
          ...
          <div class="col-lg-7 col-md-7 col-sm-12">
            <h2 class="cat-heading">Update a Category</h2>
          </div>
    ...
    ?>
	 ...
	 <?php 
      if(isset($_GET['edit_id'])){ 
            ...
            $q = "SELECT * FROM categories WHERE id='$edit_id'";                
            $r = mysqli_query($dbc,$q);
	...
	?>
                ...
                <button type="submit" id="save" name="update" class="btn btn-info2 pull-right">Update</button>
              </form>
            </div>
