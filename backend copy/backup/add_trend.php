...
session_start(); 
	...
	$q = "INSERT INTO trends (title, categ_id, price, descpt, cover, cover2, cover3) VALUES('$title', '$categ_id', '$price', '$descpt', '$cover', '$cover2', '$cover3')";
										...
										if($r){
											...
											header("refresh:3 ; add_trend.php");
										}
										else
										{
      ...
      <div class="col-lg-10 col-md-10 col-sm-12">
        ...
        <div class="row container-title"><br />
          ...
          <div class="col-lg-7 col-md-7 col-sm-12">
            <h2 class="cat-heading">Add Trends</h2>
          </div>

          <div class="col-lg-5 col-md-5 col-sm-12 setting_links">
            <p> <a href="" class="setting_add">Add</a> &nbsp;/ &nbsp;<a href="all_trends.php" class="setting_edit">All
                Trends</a> </p>
          </div>
            ...
            <div class="form-area">
              <form role="form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" name="price" placeholder="Enter product price"
                    required>
                </div>
